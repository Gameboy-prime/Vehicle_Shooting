...
public class MechEnemyGun : MonoBehaviour
{
    ...
    {
        transform.localPosition = new Vector3(-0.31f, 0.188f, 0.01f);
        transform.localRotation = Quaternion.Euler(-17.3f, -89.7f, 122.9f);
    }
